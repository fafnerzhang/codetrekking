...
class QueryFilter:
    ...
    def add_date_range(self, field: str, start: datetime = None, end: datetime = None) -> 'QueryFilter':
...
class AggregationQuery:
    ...
    def add_date_histogram(self, name: str, field: str, interval: str) -> 'AggregationQuery':
        """添加日期直方圖聚合"""
        self.aggs[name] = {"type": "date_histogram", "field": field, "interval": interval}
        return self
